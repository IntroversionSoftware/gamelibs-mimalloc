...
static inline mi_decl_forceinline void _mi_memset(void* dst, int val, size_t n) {
  if ((_mi_cpu_has_fsrm && n <= 128) || (_mi_cpu_has_erms && n > 128)) {
...
static inline mi_decl_forceinline void _mi_memset_aligned(void* dst, int val, size_t n) {
